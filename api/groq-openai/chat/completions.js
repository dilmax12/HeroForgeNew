// Serverless route: /api/groq-openai/chat/completions
// Proxies OpenAI-compatible chat completions to Groq, keeping the API key server-side.
...
export default async function handler(req, res) {
  ...
  try {
    // Body may be empty in some runtimes; attempt manual read if needed
    let body = req.body;
